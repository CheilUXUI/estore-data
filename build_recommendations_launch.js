...
async function buildRecommendations() {
    try {
        ...
        fs.writeFileSync(
            path.join(__dirname, 'recommendations_launch.json'),
            JSON.stringify({ products }, null, 2),
            'utf8'
        );

        console.log(`✓ Generated recommendations_launch.json with ${products.length} products`);
    } catch (e) {
        console.error('Failed to build recommendations_launch.json:', e.message);
    }
}
